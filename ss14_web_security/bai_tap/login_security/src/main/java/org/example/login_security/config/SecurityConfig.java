package org.example.login_security.config;

import org.example.login_security.service.UserInforDetailService;
...
//                Config các đường dẫn bắt buộc cần đăng nhập
                .authorizeHttpRequests((authorizeHttpRequests) ->
                        authorizeHttpRequests
                                .requestMatchers("/customer/create", "/logout").authenticated())
